...
const confirmPass = document.getElementById("confirm") as HTMLInputElement;
...
class FormValidation {
  ...
  static email(element: HTMLInputElement) {
    const isValidEmail =
  ...
  static password(element: HTMLInputElement, confElement: HTMLInputElement) {
